...
public class BoomAnimationFive  extends JComponent implements ActionListener{
...
//		Animation While Loop:
		while (theta < thetaO) {
		 	double thetaAngle = 0;
			double x = 1;
			double heheX = Math.random()*1.0001;
			double heheY = Math.random()*1.0001;
